    ...
    <div className="h-full w-full bg-black text-white overflow-hidden">
      ...
      <div className="p-3 md:p-4 space-y-4">
        ...
        <div className="bg-[#1a1a1a] border border-[#333333] rounded-2xl p-4">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div className="flex gap-2">
              <button className="px-3 py-1.5 bg-[#2a2a2a] rounded-lg text-xs">Refresh</button>
              <button className="px-3 py-1.5 bg-[#ffd700] text-black rounded-lg text-xs font-semibold">Export</button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#1a1a1a] border border-[#333333] rounded-2xl p-4">
          ...
          <div className="h-32 md:h-40 bg-[#0a0a0a] rounded-xl flex items-center justify-center">
